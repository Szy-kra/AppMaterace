...
export interface ProductSpecification {
    ...
    lateks: string;
    hybryda: string;
    sprezynaMiekka: string;
    sprezynaTwarda: string;
    piankaMiekka: string;
    piankaTwarda: string;
}
...
export interface ProductType {
    ...
    rodzajProd: string;
    imageSrc?: string;
    specyfikacja: ProductSpecification;
}

export const comfortTypes: string[] = ['Miękki', 'Średni', 'Twardy'];
export const coverColors: string[] = ['Biały', 'Grafitowy', 'Beżowy'];
